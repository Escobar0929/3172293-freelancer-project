// JS/components/card.js
    ...
    //containerSelecto: es un selector css donde van las cards 
    ...
    export async function loadCards(containerSelector, cardIds = []) {
        ...
        try { 
                // Hacemos dos fetch al mismo tiempo, uno para la platilla de la card y otro para los datos
        ...
        // filtro por si se proporsiona ID
